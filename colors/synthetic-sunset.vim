...
let s:cl_none =         { 'gui': 'NONE',    'cterm256': 'NONE' }
let s:cl_dark_violet =  { 'gui': '#875fd7', 'cterm256': '98' }
let s:cl_dark_blue =    { 'gui': '#8787d7', 'cterm256': '104'}
let s:cl_green =        { 'gui': '#87af00', 'cterm256': '106' }
let s:cl_blue =         { 'gui': '#87afff', 'cterm256': '111' }
let s:cl_red =          { 'gui': '#af0000', 'cterm256': '124' }
let s:cl_light_blue =   { 'gui': '#afafd7', 'cterm256': '146' }
let s:cl_red_pink =     { 'gui': '#d70087', 'cterm256': '162' }
let s:cl_orange =       { 'gui': '#d75f5f', 'cterm256': '167' }
let s:cl_pink =         { 'gui': '#d75fd7', 'cterm256': '170' }
let s:cl_bright_pink =  { 'gui': '#ff00d7', 'cterm256': '200' }
let s:cl_dark_grey =    { 'gui': '#1c1c1c', 'cterm256': '234' }
let s:cl_darker_grey =  { 'gui': '#444444', 'cterm256': '238' }
let s:cl_grey =         { 'gui': '#666666', 'cterm256': '242' }
let s:cl_light_grey =   { 'gui': '#8a8a8a', 'cterm256': '245' }
...
call <sid>hi('StatusLineNC',    s:cl_dark_grey,   s:cl_none,        'none',     {})
